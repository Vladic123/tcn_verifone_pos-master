...
//--------------------------------------------------------------------------------
	...
	public TwoPainViewGroup(final Context context, final AttributeSet attrs,
		...
		mOrientation = a.getInt(R.styleable.TwoPainViewGroup_pane_orientation, HORIZONTAL);
...
//			case MODE_SPLIT:
	...
	private void onMeasureSplit(final int maxWidth, final int maxHeight, final int widthMeasureSpec,
...
//		if (DEBUG) Log.v(TAG, "onMeasureSplit:");
	 ...
	 */
	private void onMeasureHorizontal(final int maxWidth, final int maxHeight,
...
//		if (DEBUG) Log.v(TAG, "onMeasureHorizontal:");
	 ...
	 * @param heightMeasureSpec
	 */
	private void onMeasureVertical(final int maxWidth, final int maxHeight,
								   final int widthMeasureSpec, final int heightMeasureSpec) {
//		if (DEBUG) Log.v(TAG, "onMeasureVertical:");
	...
	private void onMeasureSelect1(final int maxWidth, final int maxHeight,
								  final int widthMeasureSpec, final int heightMeasureSpec) {
//		if (DEBUG) Log.v(TAG, "onMeasureSelect1:");
	...
	private void onMeasureSelect2(final int maxWidth, final int maxHeight,
								  final int widthMeasureSpec, final int heightMeasureSpec) {
//		if (DEBUG) Log.v(TAG, "onMeasureSelect2:");
	 ...
	 * @param heightMeasureSpec
	 */
	private void callChildMeasure(final View child, final int maxWidth, final int maxHeight,
								  final int widthMeasureSpec, final int heightMeasureSpec) {
		final MarginLayoutParams lp = (MarginLayoutParams) child.getLayoutParams();
...
//			case MODE_SPLIT:
	...
	private void onLayoutSplit(final boolean changed, final int left, final int top,
...
//		if (DEBUG) Log.v(TAG, "onLayoutSplit:");
	 ...
	 * @param bottom
	 */
	private void onLayoutHorizontal(final boolean changed, final int left, final int top,
									final int right, final int bottom) {
//		if (DEBUG) Log.v(TAG, "onLayoutHorizontal:");
	 ...
	 * @param bottom
	 */
	private void onLayoutVertical(final boolean changed, final int left, final int top,
								  final int right, final int bottom) {
//		if (DEBUG) Log.v(TAG, "onLayoutVertical:");
	...
	private void onLayoutSelect1(final boolean changed, final int left, final int top,
								 final int right, final int bottom) {
...
//			case HORIZONTAL:
	...
	private void onLayoutSelect2(final boolean changed, final int left, final int top,
								 final int right, final int bottom) {
...
//			case HORIZONTAL:
	 ...
	 */
	@SuppressLint("NewApi")
	private void callChildLayout(final View child, final boolean changed, final int left,
