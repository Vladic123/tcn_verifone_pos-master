...
//================================================================================
	...
	protected void releaseNotificationChannel(@Nullable final String channelId) {
		if (!TextUtils.isEmpty(channelId) && com.serenegiant.utils.BuildCheck.isOreo()) {
			final NotificationManager manager
					= (NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);
			try {
	...
	protected void releaseNotificationGroup(@NonNull final String groupId) {
		...
		if (!TextUtils.isEmpty(groupId) && com.serenegiant.utils.BuildCheck.isOreo()) {
			final NotificationManager manager
					= (NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);
			try {
...
//================================================================================
	 ...
	 * @throws IllegalStateException
	 */
	protected void queueEvent(@Nullable final Runnable task,
	...
	public static abstract class NotificationFactory {
		...
		public NotificationFactory(
			...
			this(channelId, channelId,
					com.serenegiant.utils.BuildCheck.isAndroid7() ? NotificationManager.IMPORTANCE_NONE : 0,
