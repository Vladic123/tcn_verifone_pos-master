...
// コールバックの呼び出し
	...
	private static class WiFiDirectBroadcastReceiver extends BroadcastReceiver {
		...
		public WiFiDirectBroadcastReceiver(
				@NonNull final WifiP2pManager manager,
				@NonNull final WifiP2pManager.Channel channel,
		...
		public void onReceive(final Context context, final Intent intent) {
			...
			if (WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION.equals(action)) {
				...
				try {
					...
					if (DEBUG)
						Log.v(TAG, "onReceive:WIFI_P2P_CONNECTION_CHANGED_ACTION, networkInfo=" + networkInfo);
