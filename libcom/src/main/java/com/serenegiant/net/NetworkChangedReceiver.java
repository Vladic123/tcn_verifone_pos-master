...
//			ConnectivityManager.TYPE_VPN, NETWORK_TYPE_VPN,
	...
	private void callOnNetworkChanged(final int isConnectedOrConnecting, final int isConnected,
									  final int activeNetworkInfo) {
		if (mListener != null) {
			try {
...
//================================================================================
	...
	private void onReceiveGlobal(final Context context, final Intent intent) {
		...
		if (DEBUG)
			Log.v(TAG, String.format("onNetworkChanged:isConnectedOrConnecting=%08x,isConnected=%08x,activeNetworkMask=%08x",
	...
	public interface OnNetworkChangedListener {
		...
		void onNetworkChanged(
				final int isConnectedOrConnecting, final int isConnected,
				final int activeNetworkMask);
	}
}
