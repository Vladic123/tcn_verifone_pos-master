...
import static com.serenegiant.glutils.ShaderConst.NO_TEXTURE;
import static com.serenegiant.glutils.ShaderConst.TEX_NUMBERS;
...
public class MediaEffectDrawer {
	...
	public static MediaEffectDrawer newInstance(final int numTex,
                                                final boolean isOES, final String vss,
                                                final String fss) {
	 ...
	 * @param offset     テクスチャ変換行列のオフセット
	 */
	protected void preDraw(@NonNull final int[] tex_ids, final float[] tex_matrix,
						   final int offset) {
