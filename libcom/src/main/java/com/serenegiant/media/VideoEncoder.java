...
//	private final WeakReference<AbstractUVCCamera>mCamera;
	...
	public VideoEncoder(final Recorder recorder, final EncoderListener listener,
                        final boolean align16) {
...
/*			final AbstractUVCCamera camera = mCamera.get();
	...
	private static final native int nativeResize(long id_encoder, int width, int height,
												 int colorFormat);
	...
	private static final native int nativePrepare(long id_encoder, int width, int height,
												  int colorFormat);
}
