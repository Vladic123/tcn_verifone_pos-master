...
public class MediaMovieRecorder extends AbstractRecorder {
	...
	public MediaMovieRecorder(final String output_path,
							  final boolean audio_recording,
							  final boolean useVideoMuxer) throws IOException {
		super(output_path);
	...
	public interface IRecorderCallback {
		void onPrepared(MediaMovieRecorder recorder);

		void onStart(MediaMovieRecorder recorder);

		void onStop(MediaMovieRecorder recorder);
	}
}
