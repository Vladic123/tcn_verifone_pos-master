...
public interface IMediaCodecCallback {
     ...
     * @param codec
     */
    void onStart(IMediaCodec codec);
     ...
     * @return
     */
    boolean onFrameAvailable(IMediaCodec codec, long presentationTimeUs);
     ...
     * @param codec
     */
    void onRelease(IMediaCodec codec);
     ...
     * @return handled
     */
    boolean onError(IMediaCodec codec, Exception e);
}
