...
import static com.serenegiant.utils.BufferHelper.ANNEXB_START_MARK;
import static com.serenegiant.utils.BufferHelper.byteComp;
...
public abstract class AbstractEncoder implements Encoder {
	...
	//********************************************************************************
	public AbstractEncoder(final String mime_type, final IRecorder recorder,
...
//		if (DEBUG) Log.i(TAG, "signalEndOfInputStream:encoder=" + this);
	...
	public void encode(final ByteBuffer buffer, final int length, final long presentationTimeUs) {
		...
		@SuppressWarnings("deprecation") final ByteBuffer[] inputBuffers = mMediaCodec.getInputBuffers();
		while (mIsCapturing) {
