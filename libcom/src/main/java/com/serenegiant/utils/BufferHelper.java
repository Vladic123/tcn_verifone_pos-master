...
public class BufferHelper {
    ...
    public static final void dump(final String tag,
                                  final ByteBuffer _buffer, final int offset, final int _size,
                                  final boolean findAnnexB) {
...
//		if (DEBUG) Log.i(TAG, "dump:limit=" + n + ",capacity=" + cap + ",position=" + buffer.position());
     ...
     */
    public static final int byteComp(@NonNull final byte[] array, final int offset,
                                     @NonNull final byte[] search, final int len) {
        int index = -1;
    ...
    public static final void dump(final String tag,
                                  final byte[] buffer, final int offset, final int _size,
                                  final boolean findAnnexB) {
