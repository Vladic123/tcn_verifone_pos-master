...
public class IEnum {
    ...
    public static <E extends EnumInterface> E as(final Class<E> enumClazz,
                                                 final int id,
                                                 final String label) throws IllegalArgumentException {
    ...
    public static <E extends EnumInterface> E as(final Class<E> enumClazz,
                                                 final String label,
                                                 final int id) throws IllegalArgumentException {
     ...
     * @return
     */
    public static <E extends EnumInterface> String identity(final Class<E> enumClazz,
                                                            final String value) {
        String result = null;
