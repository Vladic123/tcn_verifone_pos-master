...
public class GPS {
    ...
    public static double distance(final Datum datum,
                                  final double latitude_degree1, final double longitude_degree1,
                                  final double altitude1,
                                  final double latitude_degree2, final double longitude_degree2,
                                  final double altitude2) {
    ...
    public static class Datum {
        ...
        public Datum(final double a, final double b, final double ellipticity,
