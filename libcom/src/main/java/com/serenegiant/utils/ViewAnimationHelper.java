...
public class ViewAnimationHelper {
	...
	public static void fadeIn(final View target, final long duration, final long startDelay,
							  final ViewAnimationListener listener) {
...
//		if (DEBUG) Log.v(TAG, "fadeOut,target=" + target);
	 ...
	 */
	@SuppressLint("NewApi")
	public static void zoomIn(final View target, final long duration, final long startDelay,
							  final ViewAnimationListener listener) {
//		if (DEBUG) Log.v(TAG, "zoomIn:target=" + target);
	 ...
	 */
	@SuppressLint("NewApi")
	public static void zoomOut(final View target, final long duration, final long startDelay,
							   final ViewAnimationListener listener) {
//		if (DEBUG) Log.v(TAG, "zoomIn:target=" + target);
		if (target == null) return;
		target.postDelayed(new Runnable() {
	...
	public interface ViewAnimationListener {
		void onAnimationStart(@NonNull final Animator animator, @NonNull final View target,
							  final int animationType);

		void onAnimationEnd(@NonNull final Animator animator, @NonNull final View target,
							final int animationType);

		void onAnimationCancel(@NonNull final Animator animator, @NonNull final View target,
							   final int animationType);
	}
}
