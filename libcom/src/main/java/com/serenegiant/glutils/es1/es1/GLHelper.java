package com.serenegiant.glutils.es1.es1;
/*
 * libcommon
...
//       	}
	 ...
	 * @return
	 */
	public static int initTex(final int texTarget, final int texUnit, final int min_filter,
							  final int mag_filter, final int wrap) {
...
// came from GLU
	...
	public static int gluProject(final float objX, final float objY, final float objZ,
								 final float[] model, final int modelOffset, final float[] project,
								 final int projectOffset,
								 final int[] view, final int viewOffset, final float[] win,
								 final int winOffset) {
	...
	public static int gluUnProject(final float winX, final float winY, final float winZ,
								   final float[] model, final int modelOffset,
								   final float[] project, final int projectOffset,
								   final int[] view, final int viewOffset, final float[] obj,
								   final int objOffset) {
