...
public class DialogInput extends Dialog {
	...
	private void init() {
		...
		setCancelable(false);
		m_Text = findViewById(R.id.dialog_input_text);
		m_Text.setTextSize(20);
		m_EditText = findViewById(R.id.dialog_input_editText);
		m_EditText_end = findViewById(R.id.dialog_input_editText_end);

		dialog_start_text = findViewById(R.id.dialog_start_text);
		dialog_end_text = findViewById(R.id.dialog_end_text);

		dialog_input_cancel_button = findViewById(R.id.dialog_input_cancel_button);
		dialog_input_cancel_button.setOnClickListener(m_ClickListener);
		dialog_input_cancel_button.setTextSize(20);
		dialog_input_sure_button = findViewById(R.id.dialog_input_sure_button);
	...
	public interface ButtonListener {
		void onClick(int buttonId, String firstData, String secondData);
	}
}
