...
public class ButtonEditSelectD extends RelativeLayout {
    ...
    private void initView(Context context) {
        ...
        btn_edit_linearLayout = findViewById(R.id.btn_edit_linearLayout);
        btn_edit_linearLayout_2 = findViewById(R.id.btn_edit_linearLayout_2);
        btn_edit_name = findViewById(R.id.btn_edit_name);
        btn_edit_query_btn = findViewById(R.id.btn_edit_query_btn);
        btn_edit_query_btn.setOnClickListener(m_ClickListener);

        btn_edit_edit_select = findViewById(R.id.btn_edit_edit_select);
        btn_edit_edit_select.setOnClickListener(m_ClickListener);

        btn_edit_edit_select_2 = findViewById(R.id.btn_edit_edit_select_2);
        btn_edit_edit_select_2.setOnClickListener(m_ClickListener);

        btn_edit_select_line = findViewById(R.id.btn_edit_select_line);
        btn_edit_select_line_2 = findViewById(R.id.btn_edit_select_line_2);

        btn_edit_select_btn = findViewById(R.id.btn_edit_select_btn);
        btn_edit_select_btn.setOnClickListener(m_ClickListener);

        btn_edit_select_btn_2 = findViewById(R.id.btn_edit_select_btn_2);
        btn_edit_select_btn_2.setOnClickListener(m_ClickListener);

        btn_edit_edit_input = findViewById(R.id.btn_edit_edit_input);

        btn_edit_display = findViewById(R.id.btn_edit_display);
