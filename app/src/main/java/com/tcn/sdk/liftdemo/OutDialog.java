...
public class OutDialog extends Dialog {
    ...
    private void init(String str, String str1) {
        ...
        time_shyu = findViewById(ResourceUtil.getId(m_Context, "time_shyu"));
        iv_route = findViewById(ResourceUtil.getId(m_Context, "iv_route"));
        tv = findViewById(ResourceUtil.getId(m_Context, "tv"));
        tv.setText(str1);
        tv_point = findViewById(ResourceUtil.getId(m_Context, "tv_point"));
        outnum = findViewById(ResourceUtil.getId(m_Context, "outnum"));
        outnum.setText(str);
        initAnim();
        timeCount = 0;
